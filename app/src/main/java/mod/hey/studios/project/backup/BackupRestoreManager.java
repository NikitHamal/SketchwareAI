...
public class BackupRestoreManager {
    ...
    private static class RestoreFromZipAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onProgressUpdate(String... values) {
            if (values.length > 0) {
                loadingDialogBinding.tvProgress.setText(values[0]);
            }
        }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                bm.restoreFromZip(new File(file), activityWeakReference.get(), this::publishProgress);
            } catch (Exception e) {
